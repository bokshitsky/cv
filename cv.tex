...
\begin{tabular}{r|p{11cm}}
  ...
  \textsc{July 2017} & \emph{The biggest online recruitment platform in Russia} \\
  & \footnotesize{
      Lead applicant services and mobile applications backend team.\newline
      Helped to set up processes and make technical decisions within the team and the company. Responsible for hiring, onboarding, and mentoring of people in the engineering team.
  ...
  \textsc{July 2017} & Software engineer at \textsc{Headhunter Group}, Moscow \\
  \textsc{July 2016} & \emph{The biggest online recruitment platform in Russia} \\
  & \footnotesize{
      Supporting the mobile version of the main product \href{https://hh.ru}{hh.ru}.\newline
      Used \textsc{Java}, \textsc{Python}, \textsc{Postgres}, \textsc{Cassandra}.\newline
      Was promoted to team lead due to work results.
  } \\\multicolumn{2}{c}{} \\

  \textsc{July 2016} & Lead Stress Engineer at \textsc{Progresstech}, Moscow \\
  \textsc{March 2015} & \emph{Boeing Company contractor at Moscow Boeing Design Center} \\
  & \footnotesize{
  ...
  \textsc{March 2015} & Stress Engineer at \textsc{Progresstech}, Moscow \\
  \textsc{August 2011} & \emph{Boeing Company contractor at Moscow Boeing Design Center} \\
  & \footnotesize{
      Performed stress analysis of aircraft structures for 787-9/10 and 737 projects.\newline
      For excellent performance was promoted to engineering team lead.
  } \\\multicolumn{2}{c}{} \\
...
\section{Education}
\begin{tabular}{r|p{11cm}}
  \textsc{June 2013} & Mechanical Engineering \\ & \textsc{Bauman Moscow State Technical University} \\
\end{tabular}
